...
const getFinancialMetrics = (company) => {
  const baseMetrics = {
                      ...
                      <LineChart data={priceData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                        ...
                        {selectedCompanies.map((company) => (
                          <Line
                            ...
                            dataKey={company}
                            name={companies.find((c) => c.value === company)?.label || company}
                            stroke={companyColors[company] || "#10b981"}
                            strokeWidth={2}
                            dot={false}
                          />
                        ))}
                      ...
                      <RadarChart cx="50%" cy="50%" outerRadius="80%" data={radarData}>
                        ...
                        {selectedCompanies.map((company) => (
                          <Radar
                            ...
                            dataKey={company}
                            stroke={companyColors[company] || "#10b981"}
                            fill={companyColors[company] || "#10b981"}
                            fillOpacity={0.2}
                          />
                        ))}
                        <Legend />
                        ...
                        {selectedCompanies.map((company) => (
                          <Bar
                            ...
                            data={[
                              {
                                period: "1 mois",
                                [company]: Math.floor(Math.random() * 20) - 10,
                              },
                              {
                                period: "3 mois",
                                [company]: Math.floor(Math.random() * 30) - 15,
                              },
                              {
                                period: "6 mois",
                                [company]: Math.floor(Math.random() * 40) - 20,
                              },
                              {
                                period: "1 an",
                                [company]: Math.floor(Math.random() * 60) - 30,
                              },
                              {
                                period: "YTD",
                                [company]: Math.floor(Math.random() * 50) - 25,
                              },
                            ]}
                          />
                        ))}
